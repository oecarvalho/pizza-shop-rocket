...
type SigInForm = z.infer<typeof signUpForm>

export function SignUp(){
    const navigate = useNavigate()
    const {register, handleSubmit, formState: {isSubmitting}} = useForm<SigInForm>();

    async function handlesignUp(data: SigInForm){
        try{
            console.log(data)
            ...
            <div className="p-8 flex flex-col items-center">
                ...
                <div className="flex w-[350px] flex-col justify-center gap-6 itemc">
                    <div className="flex flex-col gap-2 text-center">
                        ...
                        <p className="text-sm text-muted-foreground">Seja um parceiro e comeces suas vendas</p>
                    </div>
